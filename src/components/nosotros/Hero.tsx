...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="sm:mx-0 sm:px-0 pt-28 md:pt-32 lg:pt-44 xl:pt-44">
        <motion.div
          className="grid items-center gap-8 lg:grid-cols-12 lg:gap-2 xl:gap-12 overflow-hidden"
        ...
        >
          <motion.div
            className="order-2 col-span-1 lg:col-span-7 lg:order-1"
            variants={fadeInUp}
          >
          ...
          <motion.div
            className="container sm:pr-4 sm:pl-0 lg:mx-0  order-1 lg:col-span-4 xl:col-span-4 lg:order-2  lg:max-w-lg"
            variants={fadeInUp}
          >
            <h1
            ...
            <p className="mt-5 text-base leading-relaxed text-white/95 sm:text-sm lg:text-sm xl:text-lg 3xl:leading-[1.2]">
              {nosotrosHero.body}
            </p>
          </motion.div>
        </motion.div>
