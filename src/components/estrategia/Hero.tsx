...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="relative z-10 mt-20 min-w-0 overflow-hidden sm:max-h-[calc(100vh+50rem)] lg:mt-0 4xl:container">
        <motion.div
          className="grid min-w-0 grid-cols-1 gap-2 lg:grid-cols-3 lg:gap-8 lg:gap-x-12"
        ...
        >
          <motion.div
            className="relative order-2 col-span-2 flex min-w-0 justify-center lg:order-1 lg:justify-start"
          ...
          >
            <img
              ...
              width={1200}
              height={1000}
              className="relative z-[1] h-auto w-full max-w-full translate-y-[5%] object-contain drop-shadow-xl lg:mt-10 xl:-translate-x-[2%] 2xl:translate-y-[2%]"
              loading="eager"
              fetchPriority="high"
              decoding="async"
            />
